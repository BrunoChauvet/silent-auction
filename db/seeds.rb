...
item1 = Item.create(name: 'Vespa 12CV', description: 'Brand new Vespa 12CV from our sponsors')
item2 = Item.create(name: 'Coffee Machine', description: 'Breville coffee machine with 2 years waranty')
item3 = Item.create(name: 'Tahiti Escape', description: 'Holiday all inclusive package to french polynesia')
item4 = Item.create(name: 'Hunter Valley Escape', description: '2 days package in the Hunter Valley for 2 people')
item5 = Item.create(name: '12 Bottles of Bordeaux', description: 'A package of 12 bottles of Grands Crus from Burgundy (France)')
item6 = Item.create(name: 'MacBook Pro', description: '13" MacBook Pro with retina display')
